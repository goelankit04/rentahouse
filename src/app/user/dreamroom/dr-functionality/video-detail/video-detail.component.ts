...
export class VideoDetailComponent implements OnInit, AfterViewInit, OnDestroy {
  @HostBinding("class") videoDetailComponentClass = "app-video-detail";
  ...
  openPuzzle() {
    ...
    if (this.episode_puzzle) {
      this.router.navigateByUrl(
        `/user/dreamroom/dr-functionality/puzzle/${this.productId}/${this
  ...
  openExample() {
    ...
    if (this.episode_example) {
      this.router.navigateByUrl(
        `/user/dreamroom/dr-functionality/example/${this.productId}/${this
          .productId - 99}/${this.episode_id}`
      );
    }
  }
  ...
  nextVideo() {
    if (this.nextEpisode_active) {
      ...
      this.router.navigateByUrl(
        `user/dreamroom/dr-functionality/video/${this.categoryId}/${
        this.productType
        }/${this.productId}/${++temp}`
      );
